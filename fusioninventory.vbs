...
Option Explicit
Dim Force, Verbose
Dim Setup, SetupArchitecture, SetupLocation, SetupOptions, SetupVersion, uninstallocsagent
...
SetupLocation = "\\0.0.0.0\Pasta\fusioninventory\" & SetupVersion
...
'
SetupOptions = "/acceptlicense /runnow /server='http://seu.servidor.com:8086/glpi/plugins/fusioninventory/' /S"
